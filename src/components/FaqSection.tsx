...
const FAQS: FaqItem[] = [
  ...
  {
    q: '학원 원비 결제 수납 시 KSPay 수수료 및 수납 절차는 어떻게 되나요?',
    a: '학원 명의의 PG 계정을 통해 안전하게 수납되며, 매월 미납된 수강생 학부모에게 카카오 알림톡으로 간편 청구서가 전달됩니다. 학부모는 앱에서 신용카드나 카카오페이 등으로 1초 만에 결제할 수 있습니다.'
  },
  {
    q: 'VOG SPORTS 쇼핑몰 포인트는 어떻게 적립되고 사용할 수 있나요?',
    a: '원비 수납 및 신규 회원 추천 시 다단계 등급 정책에 따라 마일리지 포인트가 자동 적립됩니다. 학부모는 적립된 포인트를 제휴 스포츠용품 쇼핑몰(영카트)에서 1:1 현금처럼 사용하거나 일정 금액 이상 시 출금 신청할 수 있습니다.'
  },
  {
